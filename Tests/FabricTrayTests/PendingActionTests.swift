...
final class PendingActionTests: XCTestCase {
    ...
    func testIsDestructive() {
        ...
        XCTAssertTrue(PendingAction(kind: .cancelJob(JobRun(id: "j1", itemID: "i1", itemName: "N", status: .inProgress, startedAt: nil, endedAt: nil, failureReason: nil, workspaceID: nil, itemType: nil))).isDestructive)
